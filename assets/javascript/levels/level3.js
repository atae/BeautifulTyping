...
export const level3 = {
  ...
  currentText: ["In this study, I visualized connexin36-immunoreactive gap junctions",
   "and examined the structural features of the interconnected dendrites",
   "arising from parvalbumin (PV)-positive interneurons in layer 4 of the feline visual cortex.",
  "These viruses make sfRNAs by co-opting a",
  "cellular exoribonuclease using structured RNAs called xrRNAs.", "end"],
